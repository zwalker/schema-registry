...
public class PersistentCache<K extends Comparable<K>, V>
  ...
  public V get(K key) throws StoreException {
    try {
      ...
      throw new StoreException("Get failed", e);
    }
  }
  ...
  private void open(File envHome, boolean readOnly) throws DatabaseException {
    ...
    referencedByConfig.setForeignKeyDatabase(store);
    referencedByConfig.setForeignKeyDeleteAction(ForeignKeyDeleteAction.CASCADE);
    // Now open it
