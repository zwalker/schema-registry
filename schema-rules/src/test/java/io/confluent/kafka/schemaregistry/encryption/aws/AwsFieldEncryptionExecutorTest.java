...
public class AwsFieldEncryptionExecutorTest extends FieldEncryptionExecutorTest {
  ...
  public AwsFieldEncryptionExecutorTest() throws Exception {
    ...
    defaultConfig.put(KafkaAvroDeserializerConfig.RULE_EXECUTORS, "aws");
    defaultConfig.put(KafkaAvroDeserializerConfig.RULE_EXECUTORS + ".aws.class",
        AwsFieldEncryptionExecutor.class.getName());
    defaultConfig.put(KafkaAvroDeserializerConfig.RULE_EXECUTORS + ".aws.param." + KMS_KEY_ID,
        keyId);
    defaultConfig.put(KafkaAvroDeserializerConfig.RULE_EXECUTORS + ".aws.param." + TEST_CLIENT,
        testClient);
    ...
    reflectionProps.put(KafkaAvroDeserializerConfig.RULE_EXECUTORS, "aws");
    reflectionProps.put(KafkaAvroDeserializerConfig.RULE_EXECUTORS + ".aws.class",
        AwsFieldEncryptionExecutor.class.getName());
    reflectionProps.put(KafkaAvroDeserializerConfig.RULE_EXECUTORS + ".aws.param." + KMS_KEY_ID,
        keyId);
    reflectionProps.put(KafkaAvroDeserializerConfig.RULE_EXECUTORS + ".aws.param." + TEST_CLIENT,
        testClient);
  ...
  public void testKafkaAvroSerializer() throws Exception {
    ...
    Rule rule = new Rule("myRule", null, null,
        AwsFieldEncryptionExecutor.TYPE, ImmutableSortedSet.of("PII"), null, null, null, false);
